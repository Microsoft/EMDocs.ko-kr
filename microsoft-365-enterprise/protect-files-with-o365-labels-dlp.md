---
title: Office 365 레이블 및 데이터 손실 방지와 SharePoint Online 파일 보호 | Microsoft 문서
description: 정보 보호의 다양 한 수준 사용 하 여 SharePoint Online 팀 사이트에 대 한 Office 365 레이블 및 데이터 손실 방지 (DLP) 정책을 적용 합니다.
...
---
# <a name="protect-sharepoint-online-files-with-office-365-labels-and-data-loss-prevention"></a>Office 365 레이블 및 DLP(데이터 손실 방지)를 사용하여 SharePoint Online 파일 보호
...
13. **는 중요 한 정보를 검색 하는 경우 작업을 수행 하 시겠습니까?** 창, 클릭 * * 사용자 지정 팁 및 전자 메일 * *.
...
16. 클릭 **확인** 에 **는 중요 한 정보를 검색 하는 경우 작업을 수행 하 시겠습니까?** 창, **공유에서 다른 사람을 차단 하 고 공유 내용에 대 한 액세스를 제한** 확인란의 선택을 취소 하 고 **다음**을 클릭 합니다.
...
[Azure Information Protection을 사용한 SharePoint Online 파일 보호](protect-files-with-aip.md)
