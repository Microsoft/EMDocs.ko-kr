---
title: "Microsoft Office 추가 기능을 실행하는 엔터프라이즈 문서 보호 - Microsoft 365 Enterprise | Microsoft Docs"
description: "WIP 및 Intune을 사용하여 Office 추가 기능을 실행하는 문서의 엔터프라이즈 데이터를 보호하는 방법을 설명합니다."
author: barlanmsft
manager: angrobe
