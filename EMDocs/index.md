...
<article id="main">
    <section id="hero-content" class="graph">
        ...
        <h2>Microsoft의 Enterprise Mobility 서비스를 사용하면 조직에서 회사 데이터를 보호하면서 앱 및 장치에서 직원의 생산성을 유지할 수 있습니다.</h2>
        <!-- <ol id="actions" class="action-list">
        <li><a href="" class="button button-bordered">Learn More</a></li>
        </ol> -->
        <h3>Enterprise Mobility를 처음 사용하시나요? <a href="https://www.microsoft.com/server-cloud/enterprise-mobility/overview.aspx" target="_blank">Enterprise Mobility 페이지를 방문해 보세요. &rarr;</a></h3>
    </section>
