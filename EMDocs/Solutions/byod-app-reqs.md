...
- [STRIDE](https://msdn.microsoft.com/library/ee823878(v=cs.20).aspx)(스푸핑, 변조, 부인, 정보 공개, 서비스 거부 및 권한 상승) 방법을 사용하여 앱의 유효성을 검사했습니까?
- 앱이 개인 식별 데이터를 처리합니까?
